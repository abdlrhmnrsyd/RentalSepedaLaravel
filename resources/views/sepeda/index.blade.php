...
<div class="container mx-auto">
    <h2 class="text-2xl font-bold mb-4">Daftar Sepeda</h2>
        ...
        <table class="min-w-full bg-white border border-gray-200 rounded-lg shadow-md">
            <thead>
                <tr class="bg-gray-100 text-gray-600 uppercase text-sm leading-normal">
                    ...
                    <th class="py-3 px-6 text-left">Sewa</th>
            ...
            <tbody class="text-gray-600 text-sm font-light">
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-100">
                    <td class="py-3 px-6">{{ $sepeda->merk }}</td>
                    <td class="py-3 px-6">{{ $sepeda->sewa }}</td>
                    <td class="py-3 px-6">{{ $sepeda->jumlah }}</td>
                    <td class="py-3 px-6 text-center"><img src="{{ asset('storage/' .$sepeda->foto) }}" alt="" class="w-24 h-auto"></td>
                    <td class="py-3 px-6">
