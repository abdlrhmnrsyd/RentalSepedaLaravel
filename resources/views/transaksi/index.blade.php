        ...
        <table class="min-w-full bg-white border border-gray-200 rounded-lg shadow-md">
            <thead>
                <tr class="bg-gray-100 text-gray-600 uppercase text-sm leading-normal">
                    ...
                    <th class="py-3 px-6 text-left">Sepeda</th>
                    <th class="py-3 px-6 text-left">Tanggal Pinjam</th>
                    <th class="py-3 px-6 text-left">Tanggal Pulang</th>
                    <th class="py-3 px-6 text-left">Bayar</th>
                    <th class="py-3 px-6 text-left">Denda</th>
                    <th class="py-3 px-6 text-left">Jaminan</th>
            ...
            <tbody class="text-gray-600 text-sm font-light">
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-100">
                    <td class="py-3 px-6">{{ $transaksi->peminjam->nama }}</td>
                    <td class="py-3 px-6">{{ $transaksi->sepeda->merk }}</td>
                    <td class="py-3 px-6">{{ $transaksi->tgl_pinjam }}</td>
                    <td class="py-3 px-6">{{ $transaksi->tgl_pulang }}</td>
                    <td class="py-3 px-6">{{ $transaksi->bayar }}</td>
                    <td class="py-3 px-6">{{ $transaksi->denda }}</td>
                    <td class="py-3 px-6">{{ $transaksi->jaminan }}</td>
                    <td class="py-3 px-6">{{ $transaksi->status }}</td>
                    <td class="py-3 px-6">
